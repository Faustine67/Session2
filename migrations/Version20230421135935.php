 ...
 */
final class Version20230421135935 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE module ADD many_to_one VARCHAR(255) NOT NULL, CHANGE details details VARCHAR(255) NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE module DROP many_to_one, CHANGE details details LONGTEXT NOT NULL');
